<?php 
/**
 * Import widget JSON data, props to https://wordpress.org/plugins/widget-importer-exporter/
 *
 */
function kt_wie_import_data( $data ) {
	...
	$available_widgets = kt_wie_available_widgets();
...
function kt_wie_available_widgets() {
