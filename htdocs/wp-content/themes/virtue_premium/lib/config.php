...
function kadence_display_sidebar() {
   if (class_exists('woocommerce'))  {
        ...
        array('single.php','page-aak-about-us.php','page-aak-contact-us.php','page-aak-generic.php','page-aak-news-events.php','page-aak-people.php','page-aak-programs.php','page-aak-support-us.php','page-fullwidth.php','page-feature.php','page-portfolio.php','page-staff-grid.php','page-testimonial-grid.php','page-contact.php')
      );
  } else {
  $sidebar_config = new Kadence_Sidebar(
