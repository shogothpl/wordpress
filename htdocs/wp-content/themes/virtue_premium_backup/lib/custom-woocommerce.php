        ...
        if ( has_post_thumbnail() ) {
          ...
          <?php }
            if ( $attachment_ids ) {
              ...
              // Get srcset
              $second_image_meta = get_post_meta( $secondary_image_id, '_wp_attachment_metadata', true );
              $second_image_srcset = wp_calculate_image_srcset(array( $productimgwidth, $productimgheight), $second_product_image_url, $second_image_meta, $secondary_image_id);
              // Get alt and fall back to title if no alt
